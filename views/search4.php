...
?>
    ...
    <div class="view">
        ...
        <div class="sub-container">
            ...
            <!-- <img class="img1" src="../imgs/pixel1.jpg" alt="">
                 <img class="img2" src="../imgs/pixel2.jpg" alt="">
                 <img class="img3" src="../imgs/pixel3.jpg" alt="">
                 <img class="img4" src="../imgs/pixel4.jpg" alt=""> -->
            </div>
        </div>
    </div>
